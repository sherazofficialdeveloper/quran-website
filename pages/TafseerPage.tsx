    ...
    <div className={`pt-24 pb-0 bg-[#052e1b] ${isRtl ? 'font-amiri' : 'font-poppins'}`}>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8 lg:py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <a 
            ...
            target="_blank" 
            rel="noopener noreferrer">  <button className="px-12 mt-5 py-5 bg-[#D4AF37] text-[#052e1b] rounded-3xl font-bold hover:scale-105 hover:bg-white transition-all shadow-2xl shadow-[#D4AF37]/20 uppercase tracking-[0.2em] text-sm">
            {q.hero?.mainBtn} →
          </button></a>
        </div>
        ...
        <div className="relative animate-fade-up group" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative bg-[#0F5132]/40 backdrop-blur-xl border-2 border-[#D4AF37]/30 rounded-[4rem] p-8 shadow-2xl overflow-hidden">
            <div className="bg-gradient-to-br from-[#D4AF37]/40 via-[#B8860B]/40 to-[#D4AF37]/40 p-8 rounded-[3rem] text-center mb-10 border border-[#D4AF37]/20 relative overflow-hidden group shadow-[0_0_30px_rgba(212,175,55,0.2)]">
              <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/islamic-art.png')]"></div>
              <h2 className="font-amiri text-4xl text-white mb-4 relative z-10 font-bold">وَنَزَّلْنَا عَلَيْكَ الْكِتَابَ تِبْيَانًا لِّكُلِّ شَيْءٍ</h2>
              <p className="text-white text-sm italic mb-2 relative z-10 font-medium">"And We have revealed to you the Book as clarification for all things"</p>
              <div className="inline-block px-4 py-1.5 bg-black/20 rounded-full text-[10px] text-white uppercase font-bold tracking-widest relative z-10">Surah An-Nahl (16:89)</div>
            </div>
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 reveal">
        <div className="bg-gradient-to-br from-[#D4AF37] via-[#B8860B] to-[#D4AF37] rounded-[4rem] p-10 sm:p-16 relative overflow-hidden border-2 border-white/20 shadow-[0_20px_50px_rgba(212,175,55,0.2)] group">
          ...
          <div className="relative z-10">
            <h2 className={`font-cinzel text-3xl font-bold text-[#052e1b] mb-12 flex items-center gap-6 ${isRtl ? 'flex-row-reverse' : 'flex-row'}`}>
               <span className="text-4xl text-[#052e1b]">✦</span> {q.whyLearn?.title}
            </h2>
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 ${isRtl ? 'text-right' : 'text-left'}`}>
              {q.whyLearn?.points?.map((point: string, i: number) => (
                <div key={i} className={`flex items-center gap-5 group/item ${isRtl ? 'flex-row-reverse' : 'flex-row'}`}>
                  <div className="w-8 h-8 rounded-full bg-[#052e1b]/10 border border-[#052e1b]/30 flex items-center justify-center text-[#052e1b] group-hover/item:bg-[#052e1b] group-hover/item:text-[#D4AF37] transition-all duration-300">
                    ✓
                  </div>
      ...
      <section className="py-16 text-center px-4 reveal">
        <div className="bg-[#D4AF37]/5 py-16 rounded-[4rem] border-y border-[#D4AF37]/10">
          <h2 className="font-amiri text-4xl sm:text-5xl text-white mb-6 leading-relaxed">كِتَابٌ أَنزَلْنَاهُ إِلَيْكَ لِتُخْرِجَ النَّاسَ مِنَ الظُّلُمَاتِ إِلَى النُّورِ</h2>
          <p className="text-[#D4AF37] font-cinzel text-xl italic mb-4">"A Book We have revealed to you so that you may bring mankind out of darkness into light"</p>
          <div className="text-[10px] text-white/30 uppercase tracking-[0.8em]">Surah Ibrahim (14:1)</div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#052e1b] reveal">
        <div className="max-w-7xl mx-auto px-4 relative">
          ...
          <div className="relative">
            <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[4px] bg-gradient-to-b from-[#D4AF37]/0 via-[#D4AF37]/40 to-[#D4AF37]/0"></div>
      ...
      <section className="py-24 bg-gradient-to-r from-transparent via-[#D4AF37]/10 to-transparent reveal">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-gradient-to-r from-[#D4AF37]/5 via-[#0F5132] to-[#D4AF37]/5 rounded-[4rem] p-12 sm:p-20 text-center border-y border-[#D4AF37]/20 relative shadow-2xl overflow-hidden">
            <div className="relative z-10">
              <div className="w-20 h-20 bg-[#D4AF37] rounded-full flex items-center justify-center text-[#052e1b] text-4xl mx-auto mb-10 shadow-[0_0_50px_rgba(212,175,55,0.5)]">📖</div>
